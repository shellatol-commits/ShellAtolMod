package net.mcreator.modshellatol.command;
...
import net.mcreator.modshellatol.procedures.GuiiiiiProcedure;
import net.mcreator.modshellatol.procedures.Gui1Procedure;
import net.mcreator.modshellatol.procedures.AeiouProcedure;

@EventBusSubscriber
public class SaCommand {
	@SubscribeEvent
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("sa")

				.then(Commands.literal("playdragondeath").executes(arguments -> {
					...
					return 0;
				})).then(Commands.literal("aprilfoolsgui").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					GuiiiiiProcedure.execute(world, x, y, z, entity);
					return 0;
				})));
	}
