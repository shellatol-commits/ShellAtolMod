package net.mcreator.modshellatol;
...
import net.mcreator.modshellatol.init.*;
...
@Mod("modshellatol")
public class ModshellatolMod {
	public static final Logger LOGGER = LogManager.getLogger(ModshellatolMod.class);
	public static final String MODID = "modshellatol";

	public ModshellatolMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ModshellatolModBlocks.REGISTRY.register(modEventBus);
		ModshellatolModItems.REGISTRY.register(modEventBus);
		ModshellatolModTabs.REGISTRY.register(modEventBus);
		ModshellatolModPotions.REGISTRY.register(modEventBus);
		ModshellatolModMobEffects.REGISTRY.register(modEventBus);
		ModshellatolModMenus.REGISTRY.register(modEventBus);
